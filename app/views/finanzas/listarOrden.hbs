	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form class="form-signin" id="form_mod_orden">
				...
				<select class="form-control" id="input_id_cliente" name="id_cliente">
				...
				<input name="fecha_orden" type="text" id="input_fecha_orden" class="form-control" placeholder="fecha_orden"  autofocus="">
			</form>
